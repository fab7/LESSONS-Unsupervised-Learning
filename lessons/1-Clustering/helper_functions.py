...
def plot_q1_data():
    fig = plt.figure();
    # [INFO] Prior to version 1.0.0, the method of creating a 3D axes was different. 
    #   For those using older versions of matplotlib, change ax = fig.add_subplot(111, projection='3d') 
    #   to ax = Axes3D(fig). 
    # OBSOLETE ax = Axes3D(fig)

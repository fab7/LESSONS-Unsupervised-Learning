...
# [OBSOLETE] from sklearn.datasets.samples_generator import make_blobs

# [INFO] In the latest versions of scikit-learn, there is no module 
#  'sklearn.datasets.samples_generator' - it has been replaced with 
#  'sklearn.datasets' (see the docs); so, according to the 'make_blobs'
